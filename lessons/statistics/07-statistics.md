...
From the given information we know Elvis was a twin and had a brother.  From general pop culture we know Elvis was a male.  

To use Bayes' Theorem to answer this question some additional probability calculations are needed.
...
=======
      P(Fraternal Twin and 2 Males) = P(FT2M) = P(Fraternal Twin) * P(MM) = 1/250 * 1/4 = 1/500
>>>>>>> 00010ca9afe307a2d7a8fa6e5e380e184879a221
